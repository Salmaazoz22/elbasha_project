...
| 9 | **Company description, address, service area, hours** | About page, footer, structured data | Partly resolved 2026-09-15: service area "جميع محافظات الجمهورية / All governorates of Egypt" and Google Maps link applied (map link shown in contact section and footer). Still pending: written address, working hours, company profile. |
...
| 17 | **Service descriptions** (10 × 1–2 sentences, Arabic and English) *(found during implementation; see M-09)* | Service cards | Draft descriptions for all 10 services (Arabic and English) added 2026-09-15 with "draft": true in services.json; now visible on the site. **Pending client review**, plus the list of material types (CLIENT_REQUESTS item 1). |
...
**Status (2026-09-15):** Phases 4–6 are complete; see `docs/QA_REPORT.md` and `docs/DEPLOYMENT_GUIDE.md`. §15 items 1, 3, 4, 5, 7, 8, 11, 15 and 16 are resolved (9 partly). Still **NEEDS CLIENT INPUT**: 2, 6, 9 (address, hours, profile), 10, 12, 13, 14, 17 (review of draft descriptions + material types), 18, 19. The client-ready list is docs/CLIENT_REQUESTS.md (37 items after batch 1).
